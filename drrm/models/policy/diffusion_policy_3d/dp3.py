...
if __name__ == "__main__":
    ...
    # Global variables for config interpolation
    horizon = 8
    n_action_steps = 8
    n_obs_steps = 2
    shape_meta = {
    ...
    # Configuration using OmegaConf with Hydra instantiation
    ...
    # One-step instantiation of policy
    dp3 = instantiate(config.policy)

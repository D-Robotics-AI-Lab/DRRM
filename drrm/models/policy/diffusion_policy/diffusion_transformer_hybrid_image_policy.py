...
@dataclass
class DiffusionTransformerHybridImagePolicyConfig(PretrainedConfig):
    shape_meta: dict
...
class DiffusionTransformerHybridImagePolicy(BasePolicy, PreTrainedModel, ModuleAttrMixin):
    config_class = DiffusionTransformerHybridImagePolicyConfig

    def __init__(self, config: DiffusionTransformerHybridImagePolicyConfig):

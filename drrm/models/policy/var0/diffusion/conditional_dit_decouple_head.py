...
from .blocks import (FinalLayer, DecoupleBlock, TimestepEmbedder,
                               get_1d_sincos_pos_embed_from_grid,
                               get_multimodal_cond_pos_embed)


class DecoupleDiT(nn.Module):
    """
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            DecoupleBlock(hidden_size, num_heads, self_attn_first) for _ in range(depth)
        ])
